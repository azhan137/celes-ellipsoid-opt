function Narray = compute_bessel_value(simulation,points)
...
Narray = simulation.numerics.deviceArray(zeros(length(points(:,1)),3,particleNumber,expansionDegree,'single'));
