%%adjointRightHandSide: N_part x n_max array used as right hand side for adjoint system of equations

%%this function computes the term dFom/dE dot dE/db given the term dFom/dE, which is dependent on the figure of merit

%fom: figure of merit
%E: electric field Nx3 matrix where N is number of points used to define figure of merit
%b: scattered field coefficients from T-matrix/Mie theory

%%provide
% simulation object containing relevant optimization
% input derivative: dFom/dE, should have dimensions Nx3
% points: points where figure of merit is defined, dimension N
