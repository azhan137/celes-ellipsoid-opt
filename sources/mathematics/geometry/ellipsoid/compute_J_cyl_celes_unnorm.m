...
function [J11,J12,J21,J22,dJ11,dJ12,dJ21,dJ22] = compute_J_cyl_celes_unnorm(lmax,Ntheta,a,h,ni,ns,lambda,nu)
...
[theta_map,weight_map] = generate_gauss_weights_abscissae(Ntheta*2,0,pi/2);
    ...
    for mi = -li:li
        ...
        for lp = 1:lmax
            ...
            for mp = -lp:lp
                ...
                phi_exp = exp(1i*(mp-mi)*pi/2)*4/pi*sinc(pi/2*(mp-mi));
